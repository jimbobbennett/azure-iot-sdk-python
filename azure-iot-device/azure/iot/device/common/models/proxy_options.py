...
class ProxyOptions(object):
    ...
    def __init__(self, proxy_type, proxy_addr, proxy_port, proxy_username, proxy_password):
        """
        ...
        :param proxy_username: username for SOCKS5 proxy, or userid for SOCKS4 proxy.This parameter is ignored if an HTTP server is being used.
         If it is not provided, authentication will not be used (servers may accept unauthenticated requests).
        :param proxy_password: This parameter is valid only for SOCKS5 servers and specifies the respective password for the username provided.
        """
